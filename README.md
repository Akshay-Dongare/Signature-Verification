...
2. Downloading required models
   ...
   * Download [https://huggingface.co/Akshay-Dongare/bbox_regression_cnn.h5]([https://huggingface.co/Akshay-Dongare/CycleGAN-Signature-Verification-Dataset](https://huggingface.co/AkshayDongare/bbox_regression_cnn.h5) and place it in `SOURCE\vgg_finetuned_model`
